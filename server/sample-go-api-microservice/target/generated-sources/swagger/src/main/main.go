...
func init() {
  ...
  //routes.SetServiceImplementation(routes.NAMESPACE_API_IMPL_WRAPPER, services.NamespaceApiImplService{})
  //routes.SetServiceImplementation(routes.VM_API_IMPL_WRAPPER, services.VmApiImplService{})
